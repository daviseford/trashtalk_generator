...
d()})})();(function(){c({query:"get_RandomList"}).done(function(a){a=a.join("\n");$("#random_listGroup").html(a);d()})})();$(window).ready(function(){$(this).one("scroll",function(){p();n();m()})});$("#create_shittalk_Btn").button().click(function(a){a.preventDefault();var b=$(this).parent().parent(),d=$("#create_shittalk_Text").val();a=d.toLowerCase();-1<a.indexOf("http://")||-1<a.indexOf("https://")||-1<a.indexOf("www.")||-1<a.indexOf(".com")?(b.addClass("has-error"),$("#helpBlock2").removeClass("hidden")):
-1<a.indexOf("nigger")||-1<a.indexOf("faggot")?(b.addClass("has-error"),$("#helpBlock3").removeClass("hidden")):(a={},a.create_shittalk_Text=d,a.query="check_IfDuplicate",c(a).done(function(a){1>a?(a={},a.create_shittalk_Text=d,a.query="create_Shittalk",c(a).done(function(a){!0===a&&(console.log("Submission successful"),location.reload())})):(b.addClass("has-error"),$("#helpBlock").removeClass("hidden"))}))})});
